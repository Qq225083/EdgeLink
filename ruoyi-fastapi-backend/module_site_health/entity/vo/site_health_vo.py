...
class SiteRegisterModel(BaseModel):
    ...
    building: str = Field(description='栋别', max_length=50)
    floor: str = Field(description='楼层', max_length=50)
    process_stage: str = Field(description='工程', max_length=50)
...
class SiteHealthSiteModel(BaseModel):
    ...
    process_stage: Optional[str] = Field(default=None)
